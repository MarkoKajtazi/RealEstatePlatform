        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyType = table.Column<byte>(type: "smallint", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    X = table.Column<double>(type: "double precision", precision: 9, scale: 6, nullable: false),
                    Y = table.Column<double>(type: "double precision", precision: 9, scale: 6, nullable: false),
                    TakenImageId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FloorPlanPins", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewAngle = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FloorPlanPins_ImageId",
                table: "FloorPlanPins",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_FloorPlanPins_ListingId",
                table: "FloorPlanPins",
                column: "ListingId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FloorPlanPins_Images_ImageId",
                table: "FloorPlanPins",
                column: "ImageId",
                principalTable: "Images",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FloorPlanPins_Listings_ListingId",
                table: "FloorPlanPins",
                column: "ListingId",
